...
public class RecipeCommandToRecipeTest {
    ...
    public void setUp() throws Exception {
        UnitOfMeasureCommandToUnitOfMeasure uom = new UnitOfMeasureCommandToUnitOfMeasure();
        CategoryCommandToCategory categoryCommandToCategory = new CategoryCommandToCategory();
        IngredientCommandToIngredient ingredientCommandToIngredient = new IngredientCommandToIngredient(uom);
        NotesCommandToNotes notesCommandToNotes = new NotesCommandToNotes();

        converter = new RecipeCommandToRecipe(categoryCommandToCategory,
